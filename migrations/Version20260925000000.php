...
/**
 * Tables of the Rocket core: users, authentication servers, applications, settings, service checks, updates, and the
 * Messenger queue. Skipped where an application created them before it used rocket-core (Rocket Mailer).
 */
