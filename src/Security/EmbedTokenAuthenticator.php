...
/**
 * Authenticates an embedded page (iframe) with "Authorization: Embed <jwt>".
 * The JWT is minted by an application for one user (see EmbedController) and is short-lived.
 * The resulting session is restricted by ScopeGuardListener to the endpoints the brick declares (EmbedEndpointsInterface).
 */
