...
/**
 * Colors of the interface: the project's palette (see Rocket\Core\Theme\ProjectTheme) and, for the pages it embeds
 * (/embed/…), an application's one. Semantic colors are "#rrggbb"; the shades (50 to 950) are derived by the front.
 * Empty: the brick's default colors (app.config.ts).
 */
