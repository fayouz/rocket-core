...
use Rocket\Core\Repository\UpdateRunRepository;
use Rocket\Core\Security\Roles;
use Rocket\Core\Update\ReleaseChecker;
use Rocket\Core\Update\ScriptUpdater;
use Rocket\Core\Update\UpdateException;
use Rocket\Core\Update\UpdateManager;
use Rocket\Core\Update\UpdateMethodInput;
use Rocket\Core\Update\Updater;
use Rocket\Core\Update\UpdateSettings;
...
final class SystemUpdateController extends AbstractController
{
    ...
    private function safeLatest(): ?\Rocket\Core\Update\LatestRelease
    {
        try {
